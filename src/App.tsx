  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(214,141,69,0.22),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(41,90,82,0.16),_transparent_24%),linear-gradient(180deg,_#F5EBDD_0%,_#EFE5D7_48%,_#E9DFD2_100%)] px-4 py-6 text-[#141414] md:px-8 md:py-8">
      <div className="mx-auto max-w-[1780px]">
        ...
        <main className="mt-8 grid gap-6 xl:grid-cols-[300px_minmax(420px,0.98fr)_minmax(480px,1.08fr)] 2xl:grid-cols-[320px_minmax(460px,1fr)_minmax(560px,1.1fr)] xl:items-start">
          <section className="rounded-[32px] border border-[#141414]/10 bg-[#FBF8F2]/88 p-4 shadow-[0_18px_60px_rgba(20,20,20,0.06)] backdrop-blur xl:sticky xl:top-6 xl:max-h-[calc(100vh-9rem)] xl:overflow-y-auto">
            <div className="mb-4 border-b border-[#141414]/8 px-2 pb-4">
              <div className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#141414]/44">
                Condition Stack
              </div>
              <div className="mt-2 text-xl font-semibold tracking-[-0.04em] text-[#141414]">
                {selectedConditionMeta.title}
              </div>
              <div className="mt-2 text-sm leading-6 text-[#141414]/58">
          ...
          <section className="flex flex-col rounded-[32px] border border-[#141414]/10 bg-[#FBF8F2]/92 shadow-[0_18px_60px_rgba(20,20,20,0.06)] xl:h-[calc(100vh-9rem)] xl:overflow-hidden">
            <div className="border-b border-[#141414]/8 px-5 py-5">
              <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                <div>
                  <div className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[#141414]/44">
                    Active Condition
                  </div>
                  <div className="mt-2 text-2xl font-semibold tracking-[-0.04em] text-[#141414]">
                    {selectedConditionMeta.title}
                  </div>
                  <div className="mt-2 text-sm leading-6 text-[#141414]/58">
                    {selectedConditionMeta.description}
                ...
                <div className="rounded-full border border-[#141414]/10 bg-white/75 px-4 py-2 text-right">
                  <div className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[#141414]/42">
                    Last Sync
                  </div>
                  <div className="mt-1 text-sm font-semibold text-[#141414]/80">
                    {lastUpdated || "Never"}
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    disabled={isLoading}
                    className="flex cursor-pointer items-center gap-2 rounded-full border border-[#141414] bg-[#141414] px-5 py-3 text-[#F8F2E8] transition-all hover:border-[#C65A2E] hover:bg-[#C65A2E] disabled:cursor-wait disabled:opacity-55"
                  >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-5">
              ...
              {errorMessage && (
                <div className="mt-4 rounded-[24px] border border-rose-500/25 bg-rose-500/10 px-5 py-4 text-sm text-rose-700">
                  {errorMessage}
                </div>
              )}

              {favoriteItems.length > 0 && (
                <div className="mt-4 rounded-[26px] border border-[#141414]/8 bg-white/65 p-4">
              ...
              {isLoading && data.length === 0 ? (
                ...
                <div className="mt-4 overflow-hidden rounded-[28px] border border-[#141414]/10 bg-white/65">
          ...
          <section className="xl:sticky xl:top-6 xl:max-h-[calc(100vh-9rem)] xl:overflow-y-auto">
            <Suspense
              fallback={
                <div className="h-[520px] animate-pulse rounded-[32px] border border-[#141414]/10 bg-[#FBF8F2]/88 shadow-[0_18px_60px_rgba(20,20,20,0.06)]" />
              }
            >
              <AssetChartsPanel
