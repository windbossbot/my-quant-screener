...
const CONDITIONS = [
  ...
  { id: 4, title: "4시간 20·120선 범위", description: "4시간봉 기준 현재가가 20선 대비 +5%~-1%, 120선 대비 +2%~-10% 범위인 종목" },
  { id: 5, title: "4시간 20·240선 범위", description: "4시간봉 기준 현재가가 20선 대비 +5%~-1%, 240선 대비 +2%~-10% 범위인 종목" },
  { id: 6, title: "4시간봉 정배열", description: "4시간봉 20선, 60선, 120선이 상승 정배열인 종목" },
] as const;
