...
2. `월봉 정배열`
3. `주봉 정배열`
4. `4시간 20·120선 범위 + 일봉 20선 -3% 이상 + 상위 매수 10호가 1억 미만`
5. `4시간봉 정배열 + 상위 매수 10호가 1억 미만`
6. `4시간 30·120선 범위 + 일봉 30선 상단 + 상위 매수 10호가 1억 미만`
7. `4시간 30·120선 범위 + 일봉 20선 상단 + 상위 매수 10호가 1억 미만`
